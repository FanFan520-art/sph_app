    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="details clearfix">
          ...
          <!--分页器-->
          <Pagination :pageNo="searchParams.pageNo" :pageSize="searchParams.pageSize" :total="totalData" :continues="5" @getPageNo="getPageNo"/>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  beforeMount() {
    //使用es6新增的obejct.assign合并params和query对象的参数，改变searchParams里的属性值
  ...
  computed: {
    ...mapGetters(['goodsList', 'totalData']),
    //可以不用mapState，用mapGetters，totalData
    ...mapState({
